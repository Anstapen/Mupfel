...
{
public:
	static bool Load(const std::string& in_handle, const std::string& path);
	static bool
	LoadAnimated(const std::string& in_handle, const std::string& path, const Mupfel::ImageSpecification& spec);
	static bool
	LoadSpriteSheet(const std::string& in_handle, const std::string& path, const Mupfel::ImageSpecification& spec);
